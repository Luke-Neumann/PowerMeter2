...
OBJECTS    = main.o iot_uart.o iot_twi.o iot_timer.o iot_ads1115.o iot_external_interrupts.o rn4870.o update.o global_variables.o command_control.o verify_cmd_mode_control.o verify_cmd_mode_exit_control.o SPI.o
